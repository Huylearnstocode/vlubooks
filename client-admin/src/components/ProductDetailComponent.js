...
class ProductDetail extends Component {
      ...
      <div className="float-right">
        ...
        <form>
          ...
          <div class="mb-3">
            ...
            <input type="file" class="form-control" id="image" accept="image/jpeg, image/png, image/gif" onChange={(e) => this.previewImage(e)}  />
          </div>
  ...
  btnAddClick(e) {
    ...
    const publishyear = this.state.txtPublishYear;
  ...
  btnDeleteClick(e) {
    e.preventDefault();
    if (window.confirm('BẠN ĐÃ CHẮC CHẮN VỚI QUYẾT ĐỊNH?')) {
      const id = this.state.txtID;
      if (id) {
