        ...
        <div key={item._id} className="inline mx-5 ">
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Text className="text-center">Giá: {item.price}</Card.Text>
            </Card.Body>
    ...
    return (
      <div className=''>
        <div className="align-center">
          <h4> </h4>
          <h2 className="text-center mt-2">Sản Phẩm Mới</h2>
          {newprods}
        </div>
        {this.state.hotprods.length > 0 ?
          <div className="align-center">
            <h2 className="text-center mt-2">Sản Phẩm Bán Chạy</h2>
            {hotprods}
          </div>
          : <div />}
      </div>
