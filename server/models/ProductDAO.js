...
const ProductDAO = {
  ...
  async update(product) {
    const newvalues = { name: product.name, price: product.price, image: product.image, category: product.category, author: product.author, publishyear: product.publishyear };
